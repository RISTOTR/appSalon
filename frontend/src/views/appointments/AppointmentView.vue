...
<template>
   <h2 class="text-4xl font-extrabold text-white">Detalles Cita y resumén</h2>
    <p class="text-white text-lg">A continuación verifica la información y confirma su cita</p>

    <h3 class="text-3xl font-extrabold text-white"></h3>
    ...
    <div class="space-y-8" v-if="!appointments.noServicesSelected">
      <h3 class="text-3xl font-extrabold text-white">Fecha y Horas</h3>
